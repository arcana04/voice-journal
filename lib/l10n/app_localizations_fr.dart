...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get onboardingPage2Body =>
      'Ce que tu dis est transcrit par l\'IA et automatiquement classé en entrée de journal, idée ou tâche.';
  ...
  String get onboardingMicTitle =>
      'Utilisation du micro et envoi de données à l\'IA';

  @override
  String get onboardingMicBody =>
      'Tes enregistrements et les textes que tu écris sont envoyés à OpenAI (un service d\'IA tiers) pour être transcrits, classés, résumés et utilisés dans le chat IA. Quand la demande d\'autorisation apparaîtra, appuie sur \"Autoriser\".';

  @override
  String get onboardingAiConsentLabel => 'J\'ai compris et j\'accepte';
  ...
  String get integrationsSelectedCalendarMissing =>
      'Le calendrier que tu avais sélectionné est introuvable — il a peut-être été supprimé. Choisis-en un autre ci-dessous.';

  @override
  String get integrationsGoogleCalendarHint =>
      'Envie d\'utiliser Google Agenda ? Ajoute ton compte Google dans Réglages iOS → Calendrier → Comptes, il apparaîtra ici.';
  ...
  String get appleRemindersSelectedListMissing =>
      'La liste que tu avais sélectionnée est introuvable — elle a peut-être été supprimée. Choisis-en une autre ci-dessous.';
  ...
  @override
  String get watchPairingPendingTitle => 'Confirmation impossible';

  @override
  String get watchPairingPendingMessage =>
      'Les infos de couplage ont été envoyées à la Watch, mais on n\'a pas pu confirmer que ça s\'est terminé. Garde la Watch à proximité avec son app ouverte et réessaie.';
  ...
  @override
  String get planChangeCta => 'Changer de forfait';

  @override
  String get planChangeDescription =>
      'Passez du forfait mensuel au forfait annuel, ou inversement';
  ...
  String customDictionaryLimitReached(Object count) {
    return 'Tu peux enregistrer jusqu\'à $count mots';
  }

  @override
  String customDictionaryWordTooLong(Object count) {
    return 'Les mots doivent faire $count caractères ou moins';
  }
  ...
  String get diaryWeekStoryTooltip =>
      'Voir le journal de la semaine façon story';
  ...
  String get videoTooLargeToAttach =>
      'Cette vidéo est trop volumineuse pour être jointe (500 Mo max)';
  ...
  @override
  String get diaryBgBicycle => 'Vélo';

  @override
  String get diaryBgRainyWindow => 'Fenêtre pluvieuse';

  @override
  String get diaryBgTornPaper => 'Papier déchiré';

  @override
  String get diaryBgCrescentMoon => 'Croissant de lune';

  @override
  String get diaryBgStarrySky => 'Ciel étoilé';

  @override
  String get diaryBgRibbon => 'Ruban';

  @override
  String get diaryBgBlueFlowers => 'Fleurs bleues';

  @override
  String get diaryBgSunnyRoom => 'Pièce ensoleillée';

  @override
  String get diaryBgBathroom => 'Salle de bain';

  @override
  String get diaryBgStreetLamp => 'Réverbère';
  ...
  String get weeklyReportConstellationNoData =>
      'Pas encore d\'entrées d\'humeur cette semaine';
